...
type AttachmentServiceInterface interface {
	...
	GetAttachments(entityType, entityID *string, limit, offset int) ([]models.AttachmentResponse, error)
	GetAttachmentsByEntity(entityType, entityID string) ([]models.AttachmentResponse, error)
