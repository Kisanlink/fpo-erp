...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CancelSaleRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.CancelSaleResponse"
                                        }
                                    }
                                }
                            ]
                    ...
                    "409": {
                        "description": "Conflict - sale cannot be cancelled",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponseModel"
                        }
                    },
        ...
        "/api/v1/webhooks/ecommerce/order/confirmed": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Order confirmed webhook payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.OrderConfirmedWebhook"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/webhooks/ecommerce/order/created": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Order created webhook payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.OrderCreatedWebhook"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/webhooks/ecommerce/order/delivered": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Order delivered webhook payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.OrderDeliveredWebhook"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/webhooks/ecommerce/order/payment": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Order payment webhook payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.OrderPaymentWebhook"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/webhooks/ecommerce/order/shipped": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Order shipped webhook payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.OrderShippedWebhook"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/webhooks/history": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by status (processing, success, failed)",
                        "name": "status",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "models.CancelSaleRequest": {
            ...
            "properties": {
                ...
                "skip_inventory_return": {
                    "type": "boolean"
                }
            }
        },
        "models.CancelSaleResponse": {
            "type": "object",
            "properties": {
                "cancellation_id": {
                    "type": "string"
                ...
                "financial_adjustments": {
                    "$ref": "#/definitions/models.FinancialAdjustmentsResponse"
                },
                "inventory_restored": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.InventoryRestoredItem"
                    }
                },
                "sale": {
                    "$ref": "#/definitions/models.SaleResponse"
        ...
        "models.FinancialAdjustmentsResponse": {
            "type": "object",
            "properties": {
                "discount_reversed": {
                    "$ref": "#/definitions/models.DiscountReversedInfo"
                },
                "tax_voided": {
                    "$ref": "#/definitions/models.TaxVoidedInfo"
                }
            }
        },
        ...
        "models.OrderCreatedWebhook": {
            ...
            "properties": {
                "collaborator": {
                    "$ref": "#/definitions/models.WebhookCollaborator"
                },
                "event_id": {
                    "type": "string"
                },
                ...
                "fpo": {
                    "$ref": "#/definitions/models.WebhookFPO"
                },
                "items": {
                    "type": "array",
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/models.WebhookOrderItem"
                    }
                },
                "order": {
                    "$ref": "#/definitions/models.WebhookOrder"
                },
                "timestamp": {
                    "type": "string"
                }
        ...
        "models.OrderDeliveredWebhook": {
            ...
            "properties": {
                ...
                "items": {
                    ...
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/models.WebhookDeliveryItem"
                    }
                },
                "timestamp": {
                    "type": "string"
        ...
        "models.SaleResponse": {
            ...
            "properties": {
                ...
                "cancelled_at": {
                    "description": "Cancellation fields",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
        ...
        "models.WebhookCollaborator": {
            ...
            "properties": {
                "address_id": {
                    "description": "Reference to AAA address (AAA is source of truth)",
                    "type": "string"
                },
                "bank_account_no": {
                    "type": "string"
        ...
        "models.WebhookEvent": {
            ...
            "properties": {
                ...
                "event_type": {
                    "description": "order.created, order.confirmed, etc.",
                    "type": "string"
                },
                "external_order_id": {
                ...
                "purchase_order_id": {
                    "description": "Created/Updated PO ID",
                    "type": "string"
                },
                "request_body": {
                    "description": "Full JSON payload for debugging",
                    "type": "string"
                },
                "signature_valid": {
                    "description": "HMAC signature verification result",
                    "type": "boolean"
                },
                "source_ip": {
        ...
        "models.WebhookFPO": {
            ...
            "properties": {
                "delivery_address": {
                    "$ref": "#/definitions/models.WebhookAddress"
                },
                "fpo_id": {
                    "type": "string"
                }
        ...
        "models.WebhookOrderItem": {
            ...
            "properties": {
                "product": {
                    "$ref": "#/definitions/models.WebhookProduct"
                },
                "quantity": {
                    "type": "integer"
                },
                ...
                "variant": {
                    "$ref": "#/definitions/models.WebhookVariant"
                }
            }
        },
